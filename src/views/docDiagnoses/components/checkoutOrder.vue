    ...
    <div class="diagnoses_doc" :style="'min-height:' + height">
      ...
      >
        ...
        >
          <div class="top">
            <img
              v-if="item.order_state_other==1"
              src="../image/order_status_1.png"
              alt=""
              class="w16 h16 mr5 fl mt12"
            >
            <img
              v-if="item.order_state_other==2"
              src="../image/order_status_2.png"
              alt=""
              class="w16 h16 mr5 fl mt12"
            >
            <img
              v-if="item.order_state_other==3"
              src="../image/order_status_3.png"
              alt=""
              class="w16 h16 mr5 fl mt12"
            >
            <img
              v-if="item.order_state_other==4"
              src="../image/order_status_4.png"
              alt=""
              class="w16 h16 mr5 fl mt12"
            >
            <img
              v-if="item.order_state_other==5 || item.order_state_other==7"
              src="../image/order_status_5.png"
              alt=""
              class="w16 h16 mr5 fl mt12"
            >
            <img
              v-if="item.order_state_other==6"
              src="../image/order_status_6.png"
              alt=""
              class="w16 h16 mr5 fl mt12"
            >
          ...
          <div class="content">
            <div class="left">
              <div class="info">
                <div
                  class="backgroundimg info_img mr15"
                  :style="
                    generateImageUrl(
                      item.pat_icon,
